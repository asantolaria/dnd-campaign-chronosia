# 🎲 Eventos Temporales, Espaciales y Tablas Aleatorias
## *Los Gritos del Tiempo y el Espacio Rotos*
...
| 10 | **Sombras Multiplicadas**: Una sombra errante duplica la imagen de un PJ: un clon imperfecto aparece con intenciones impredecibles. |
| 11 | **Fractura de Memoria**: Un PJ olvida un hechizo, habilidad o incluso relación importante durante 1d4 horas. |
| 12 | **Grito de los Dioses**: Se escucha un rugido distante en el aire. Todos los PJ deben hacer una tirada de salvación de Sabiduría (CD 16) o sufrir una visión de un futuro terrible y obtener desventaja en todas las tiradas por 10 minutos. |

---

## 🌌 **Eventos Espaciales Aleatorios**

### **Tabla de Distorsiones Espaciales (1d12)**

| d12 | Evento Espacial Aleatorio |
|-----|---------------------------|
| 1 | **Compresión Dimensional**: La distancia entre dos puntos se reduce a la mitad. Los PJ pueden moverse el doble de rápido entre esos puntos. |
| 2 | **Inversión de Gravedad**: La gravedad se invierte en un radio de 30 pies. Todos los objetos y criaturas caen hacia arriba. |
| 3 | **Portal Espontáneo**: Un portal dimensional se abre temporalmente, conectando dos ubicaciones distantes. |
| 4 | **Transparencia Parcial**: Un PJ se vuelve parcialmente transparente. Puede atravesar objetos sólidos pero sufre desventaja en ataques. |
| 5 | **Duplicación Espacial**: Un objeto o criatura se duplica exactamente, pero la copia es un reflejo dimensional. |
| 6 | **Distorsión de Dirección**: Las direcciones se invierten. "Izquierda" se convierte en "derecha", "arriba" en "abajo". |
| 7 | **Fractura Dimensional**: Una grieta en el espacio aparece, mostrando una dimensión paralela. |
...
## 🌊 **Los Gritos de los Dioses en Conflicto**

### **Tabla de Gritos de Amaunator y Voidar (1d10)**
...
| 5 | **Grito de Venganza**: Los enemigos obtienen ventaja en todas las tiradas de ataque por 1 hora. |
| 6 | **Grito de Lamento**: Un evento trágico del pasado se manifiesta físicamente y debe ser enfrentado. |
| 7 | **Grito de Esperanza**: Un aliado perdido aparece brevemente para dar un mensaje de esperanza. |
| 8 | **Grito de Advertencia**: Los PJ reciben una visión de un peligro futuro que deben evitar. |
| 9 | **Grito de Poder**: Un PJ obtiene temporalmente un poder relacionado con el tiempo o el espacio. |
| 10 | **Grito de Liberación**: Un fragmento del poder de los dioses se libera, causando efectos temporales y espaciales masivos en toda la región. |
