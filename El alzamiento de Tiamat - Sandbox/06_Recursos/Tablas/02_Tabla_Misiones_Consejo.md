# 🗺️ Tabla de Misiones del Consejo
## *Misiones Disponibles por Concilio*

---

> **📖 NAVEGACIÓN:**
> - [Índice de Tablas](./00_Indice_Tablas.md) - Volver al índice
> - [Estructura de Aventuras](../../05_Aventuras/00_Estructura_Aventuras.md) - Estructura general
...
| **Adicional** | Misión adicional o secundaria que NO aparece en la campaña original (desarrollada en `05_Aventuras/`) |
| **En Curso** | Misión actualmente activa |
| **Disponible** | Misión disponible para elegir |
| **Completada** | Misión ya jugada en esta campaña |
| **No Disponible** | Misión bloqueada o aún no desbloqueada |

> **📖 IMPORTANTE:**
> - Las misiones **Oficiales** y **Adicionales oficiales** se consultan en el PDF original o en 5e.tools
> - Solo las misiones **Adicionales** (que NO están en la original) están desarrolladas en la carpeta `05_Aventuras/`
> - Ver [Estructura de Aventuras](../../05_Aventuras/00_Estructura_Aventuras.md) para más detalles

---

## 🔀 **SISTEMA DE RAMIFICACIONES DE MISIONES**

### **Concepto General**

Las misiones **oficiales** siempre están disponibles cuando corresponda. Las misiones **adicionales** están organizadas en **nodos de decisión** donde elegir una misión bloquea las otras del mismo nodo.
...
| #        | Misión                                                 | Enlace                                                                                               | Tipo      | Estado        | Localización                                                               | Nivel | Eventos del Consejo                                                                                                                                                             | Bloquea a                                     | Descripción                                                                                                                                                                        |
| -------- | ------------------------------------------------------ | ---------------------------------------------------------------------------------------------------- | --------- | ------------- | -------------------------------------------------------------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **04B**  | **El Culto Contraataca II: Fuego en el Norte**         | [Ver misión](../../05_Aventuras/04B_Culto_Contraataca_II_Fuego_Norte.md)                             | Oficial   | ✅ Completada | Entre el 2º y 3º Consejo                                                   | 10-11 | No ayudar en el ataque de una ciudad aliada / Ciudad destruida por un dragón enemigo / Fracasar en rescatar a un aliado / Ayudar en ciudad asediada / Salvar caravana (Parte I) | **AN14** (Nodo 1, si jugáis Parte I Everlund) | Fase II del Culto: guion **Everlund** (Chuth, caravana) + menú de encuentros 2–4. **Nodo 1:** la Parte I sustituye el antiguo **AN03**; si la jugáis, bloquea **AN14** como antes. |
| **02**   | **El Mar de Hielo Movedizo**                           | 📖 PDF/5e.tools<br/>💎 [Opciones de Botín](../../05_Aventuras/02_Mision_Mar_Hielo_Movedizo_Botin.md) | Oficial   | ✅ Completada | Norte helado                                                               | 9-10  | Matar a Arauthator o expulsarlo / Salvar a una caravana del norte / Ciudad destruida por un dragón enemigo                                                                      | -                                             | Rescatar a Maccath la Carmesí, obtener información sobre dragones blancos y la Hermandad Arcana.                                                                                   |
| **03**   | **Neronvain el Verde**                                 | [Ver misión](../../05_Aventuras/03_Mision_Neronvain_Verde.md)                                        | Oficial   | ✅ Completada | Altand (The High Forest)                                                   | 10-11 | Matar a Neronvain / Capturar a Neronvain / Matar a Chuth o expulsarlo / Negociar con los elfos de Melandrach / Matar a Melandrach sin juicio                                    | -                                             | Descubrir la traición del hijo del rey élfico y decidir su destino político (adaptada a Altand).                                                                                   |
| **AN14** | **Ruinas del Norte**                                   | [Ver misión](../../05_Aventuras/AN14_Mision_Ruinas_Norte.md)                                         | Adicional | 🔴 No Disponible | Entre el 2º y 3º Consejo (alternativa a Everlund en Nodo 1)                | 10-11 | Ciudad destruida por un dragón enemigo / Fracasar en una misión importante                                                                                                      | **04B Parte I** (Nodo 1)                      | Explorar las ruinas de una ciudad arrasada por dragones, rescatar supervivientes y descubrir pistas sobre el ritual.                                                               |
| **AN10** | **Juicio de Melandrach y Concilio de Aguas Profundas** | [Ver misión](../../05_Aventuras/AN10_Juicio_Melandrach_y_Concilio_Aguasprofundas.md)                 | Adicional | ✅ Completada | Tras **03** (Neronvain vivo); **Waterdeep**: juicio + **Segundo Concilio** | 11-12 | Negociar con los elfos de Melandrach sobre Neronvain / Matar a Melandrach sin juicio                                                                                            | **AN11** (Nodo 2)                             | Parte I: juicio élfico bajo techo aliado. Parte II: 2.º Concilio; **Rian** (Neverember); ganchos e inicio de intriga Jamna → AN11.                                                 |
| **AN11** | **Sombras en el Consejo**                              | [Ver misión](../../05_Aventuras/AN11_Mision_Sombras_Consejo.md)                                      | Adicional | 🔴 No Disponible | Entre el 2º y 3º Consejo                                                   | 11-12 | Aceptar la ayuda de un espía Zhentarim / Traición dentro del Consejo                                                                                                            | **AN10** (Nodo 2)                             | Un agente Zhentarim ofrece información a cambio de favores; los PJs deben decidir si aceptarla y sus consecuencias.                                                                |
...
### **Misiones Oficiales (8)**

1. Varram el Blanco – Tumba de Diderius
2. El Mar de Hielo Movedizo
3. Neronvain el Verde
4. El Culto Contraataca I, II, III (Emboscadas, Ofensiva, Desesperación)
5. Dragones Metálicos, Alzaos
6. Torre de Xonthal
7. Misión a Thay
8. El Retorno de Tiamat – Pozo de los Dragones
...
1. **Al inicio de cada Concilio:**
   - Revisa qué misiones están "Disponibles"
   - Identifica qué misiones están en nodos de decisión
   - Presenta estas opciones a los jugadores narrativamente
   - Permite que elijan qué misión abordar

2. **Gestión de Estado:**
   - **En Curso:** Misión que los PJs están realizando actualmente
   - **Disponible:** Misiones que pueden elegir
   - **No Disponible:** Misiones bloqueadas o aún no desbloqueadas
...
4. **Desbloqueo de Misiones:**
   - Algunas misiones se desbloquean al completar otras
   - Otras se desbloquean según el tiempo o eventos
   - Algunas pueden desaparecer si otra facción las completa

5. **Aplicar Eventos:**
   - Cuando se complete una misión, aplica los eventos del Consejo correspondientes
   - Actualiza la [Tabla de Puntuación del Consejo](./01_Tabla_Puntuacion_Consejo.md)
   - Si una misión bloquea a otras, actualiza sus estados inmediatamente

### **Para los Jugadores:**

- **NO deben ver esta tabla completa** - solo las misiones disponibles
- **Describe las opciones** narrativamente, no como lista
- **Mantén el misterio** sobre qué misiones existen pero no están disponibles
...
5. **Juicio de Melandrach y Concilio de Aguas Profundas** (Adicional — tras [03] con Neronvain **vivo**; **juicio + Segundo Concilio** en Waterdeep; abre **cuatro frentes** del Tercer Concilio)
6. **Sombras en el Consejo** (Adicional — **al día siguiente** de AN10; hurto en bóveda; **nota al margen** en el pleno, no prioridad roja del despacho)
...
- **Tabla de Puntuación:** Ver [01_Tabla_Puntuacion_Consejo.md](./01_Tabla_Puntuacion_Consejo.md)
- **Estructura de Aventuras:** Ver [../../05_Aventuras/00_Estructura_Aventuras.md](../../05_Aventuras/00_Estructura_Aventuras.md)
- **Sistema del Consejo:** Ver [../../04_Guia_DM/05_Sistema_Consejo_Guerra.md](../../04_Guia_DM/05_Sistema_Consejo_Guerra.md)
- **Sistema de Ramificaciones:** Ver [../../04_Guia_DM/03_Sistema_Ramificaciones_Misiones.md](../../04_Guia_DM/03_Sistema_Ramificaciones_Misiones.md) (si existe)
- **Asistentes del Consejo:** Ver [../../04_Guia_DM/06_Asistentes_Consejo.md](../../04_Guia_DM/06_Asistentes_Consejo.md)

---

*Esta tabla permite al DM gestionar dinámicamente qué misiones están disponibles en cada momento de la campaña.*
