...
| **Aspecto** | **Detalle** |
|-------------|-------------|
| **Tipo** | Oficial (Rise of Tiamat) — Investigación / Combate / Política élfica |
| **Nivel recomendado** | 10–11 |
...
## 🔄 **ADAPTACIONES PACTADAS**

Estos son los cambios acordados respecto a la misión oficial; **todo lo que sigue está ya integrado** en este documento.

| **Original (libro)** | **Adaptación en esta campaña** |
|----------------------|--------------------------------|
...
## 📖 **CORRESPONDENCIA CON EL ORIGINAL (LIBRO / 5e.tools)**

Para quien tenga el libro *Rise of Tiamat* o use [5e.tools → Rise of Tiamat → Neronvain / Green Dragon Lair](https://5e.tools/adventure.html#rot,-1,neronvain,1):
...
| Guarida: entrada con charca, repisa, túneles, cámara con estalactitas/isla | **Misma estructura** adaptada: entrada con **pool**, **repisa** (elfos cultistas), túneles, **cámara principal** alta (≈40 ft) con estalactitas; ver Escenas 2–4. |
| Defensores: elfos cultistas, dragonclaw/dragonfang, ettins | Incluidos como opciones en Escenas 2–3 (dracos guardianes, cultistas, dracónidos; opcional: **ettins**, **elfos cultistas**). |
| Neronvain: hechizos (ice storm, dimension door), Draconic Majesty, nube venenosa, eldritch arrow, CR 9 | En este documento hay **dos versiones**: una simplificada (combate cuerpo a cuerpo/arco) y una **versión libro** con hechizos y habilidades oficiales (ver Encuentros). |

---

## 📜 **GANCHO INICIAL**

Los PJ **no necesitan** que el Consejo les asigne la misión para empezar. Ya tienen:

1. **En Everlund:** Los refugiados elfos de la zona (Altand y alrededores) contaron lo vivido (ataques del dragón, muertes, huida con salvoconducto de Alagarthas).
2. **Nota de Delaan Winterhound** (entregada por el capitán de los refuerzos): *Alagarthas está en peligro, se esperan más ataques y se sospecha que el amo del dragón es un elfo.*
...
Toda la información necesaria para dirigir sin consultar otras fuentes.
...
### **Chuth**
- **Rol:** Dragón verde joven, aliado de Neronvain.
- **Personalidad:** Cruel, territorial; obedece a Neronvain (Máscara del Dragón Verde).
- **Situación en esta campaña:** Es el **mismo** dragón que atacó Everlund; huyó herido tras 3 impactos de ballesta. Opcional: llegar a Altand aún recuperándose (menos PV o desventaja temporal).
- **Estadísticas:** Ver bloque **Chuth (dragón verde joven)** en Encuentros.
...
- **No está en escena:** Solo se le menciona como fuente de la pista ("Alagarthas en peligro, amo del dragón podría ser un elfo").

---

## ⚙️ **OBJETIVOS**

1. Llegar al **campamento de avanzada** élfico (Galin conduce a los PJ) y contactar con **Alagarthas**.
...
Cada escena está pensada para jugarse en orden; el DM puede acortar o combinar según el ritmo.

---

### **ESCENA 1 — Campamento de avanzada**

**Objetivo:** Llegar al campamento élfico con Galin, conocer a Alagarthas en su contexto de conflicto con el Culto y recibir la información necesaria para localizar la guarida del dragón.

**Situación:** **Galin** conduce a los PJ al **campamento de avanzada** donde **Alagarthas** y sus soldados están en **conflicto constante** con el Culto del Dragón.

---

**Llegada al campamento:**

Al entrar en el campamento de avanzada de los elfos, los **sonidos y olores de la batalla** y de **hombres heridos** ponen en alerta. El campamento no es más que una **selección de tiendas hechas apresuradamente**, débilmente **barricadas por una pared de estacas de madera** en el lado este. Quienes no están luchando activamente descansan y curan sus heridas. En el desorden de **hombres enfermos y moribundos**, un **guerrero elfo con un cota de mallas de aspecto caro** se sienta junto a una soldado a la que **le falta toda la mitad inferior del cuerpo**. **Galin** señala al elfo y dice **"Ahí está tu hombre"**, antes de **irse rápidamente**.
...
### **ESCENA 2 — En el bosque. Rastreando al dragón**
...
**Un rescate oportuno (encuentro con la dríada):**

Mientras los personajes viajan por el bosque, escuchan el **crujido de un gran árbol rompiéndose**, seguido de una **voz femenina que grita**. Si investigan, ven a una **mujer venerable, envuelta en hojas**, con la **pierna atrapada bajo un pesado árbol caído**. Pide ayuda cuando ve al grupo. Esta **dríada** es la cuidadora de esta parte del bosque.

- **Tres árboles despertados** están escondidos entre los demás árboles cercanos; **uno** ha caído intencionada e inofensivamente sobre la dríada, lo que le permite **fingir una lesión** y atraer a los personajes. Ella **adivina correctamente** que el grupo busca al dragón y desea darles una **bendición** para ayudar en su lucha contra esta plaga del bosque, pero **quiere probar primero su carácter**: no ayudará a quien no ayude a los demás.
- **Inteligencia (Investigación) CD 18** o **Naturaleza CD 15:** revela que la mujer es, de hecho, una **dríada**.

**Si los personajes ayudan a la dríada sin reservas**, leer (o parafrasear) lo siguiente:

> Se necesita todo vuestro esfuerzo para levantar el árbol, sabiendo que os ponéis en riesgo si se mueve contra vosotros. Pero entonces, incluso cuando estáis a punto de liberar a la mujer, **el árbol comienza a levantarse por sí solo**. Otros dos árboles que están de pie cerca **se mueven** por el suelo mientras la elfa se pone de pie y sonríe, **sin mostrar signos de lesión**.  
> "¡Héroes por fin!", dice. "¿Cuántos podrían retroceder con miedo al ver a un extraño en el bosque, o pensar primero en su propia seguridad antes de ayudar a otro? Les concedo mi bendición. Sepan esto: el dragón que buscan es uno de gran poder; ha contaminado este lugar sagrado con **hongos venenosos**; estos **bloquearán su camino a la cueva** en la que se esconde. No conozco la naturaleza del hogar de la bestia, pero **no es de este mundo**."  
> La mujer recoge flores de su cabello y las teje en **guirnaldas** como por arte de magia. Coloca una guirnalda alrededor del cuello de cada uno de vosotros y, de repente, **entra en el árbol** que una vez la aprisionó como si fuera una piscina de agua. En un movimiento fluido, se ha ido.

**Efecto de las guirnaldas:** Mientras los personajes lleven puestas estas guirnaldas, **sentirán calidez** de la guirnalda en presencia de **dragones en el Bosque Brumoso** y tendrán **ventaja en las tiradas de salvación contra la Presencia Aterradora** del dragón.

**Si los personajes ignoran a la dríada:** Ella pide ayuda lastimosamente mientras se alejan y ofrece un último lamento contra su cobardía a medida que desaparecen.
...
**Opciones adicionales del DM (encuentros menores):**

- **Solo narrativo:** Vuelo lejano del dragón, gritos de bestias, restos de campamentos del Culto.
- **Encuentro menor:** 1d4+1 **dracos guardianes** o 2d4 **cultistas del dragón** en patrulla. Si capturan a un cultista: "Servimos al Verde. El amo vive en la cueva con el dragón."

---

**Salida:** Los PJ llegan a la **zona de hongos gigantes** y localizan la entrada a la **cueva** (los hongos bloquean o rodean el acceso; la boca de la cueva tiene **charco/poza** en la entrada y un acceso en forma de "araña"). Opcional en el acceso: **arañas** y **ettercaps** (1d3 ettercaps + enjambre de arañas) antes de entrar. → Escena 3 (Entrada a la guarida).

---

### **ESCENA 3 — Entrada a la guarida**

**Objetivo:** Entrar en la guarida, ambiente hostil y posible combate de apoyo.

**Situación (alineada con el original libro/5e):** Tras la boca de la cueva (y el **charco** en la entrada), el interior se estructura así:
- **Entrada / primer tramo:** Charco profundo pero vacío; un **pasillo elevado (repisa)** al sur vigilado por **elfos cultistas** (2d4) — pueden intentar no dar la alarma (sigilo) o combatir.
- **Túnel al norte:** Conduce a una zona con **dragonclaw** y **dragonfang** (1d3+1 en total) y 2 cultistas; combate corto pero intenso. Opcional: **ettins** (1d2) en una cámara lateral si el grupo es fuerte.
- **Cámara principal:** Techo alto (**≈40 pies**), **estalactitas y estalagmitas**; en el centro puede haber una zona tipo "isla" o plataforma donde descansa **Chuth**. Restos de tesoros, símbolos del Culto, y a veces **prisioneros elfos** (1d3) en cadenas. **Cámara secundaria** para Neronvain: objetos personales, diario, la Máscara si no la lleva puesta.

**Enemigos posibles (elegir según nivel del grupo):**
- **En la repisa (sur):** 2d4 **elfos cultistas** o 2 **dracos guardianes** + 4 **cultistas del dragón**. Evitar que den la alarma (eliminar rápido o sigilo).
- **En el túnel norte / cámara intermedia:** 1–2 **dracónidos** (dragonclaw/dragonfang) + 2 cultistas; opcional 1d2 **ettins**. Pueden custodiar prisioneros elfos (1d2); uno puede dar la pista: "El elfo y el dragón están más adentro."
...
## ⚔️ **ENCUENTROS — ESTADÍSTICAS**

Todo lo necesario para no depender del Manual de Monstruos u otras fuentes externas. Valores redondeados para uso rápido.

---

### **Chuth — Dragón verde joven**

*(Equivalente a Young Green Dragon, MM; opcional: reducir PV si llega herido de Everlund.)*

| **Atributo** | **Valor** |
|--------------|-----------|
| **CA** | 18 (armadura natural) |
| **PV** | 136 (16d10 + 48); *opcional herido:* 100–110 |
| **Velocidad** | 40 ft., trepa 40 ft., vuela 80 ft. |
| **Resistencias** | Inmunidad veneno; resistencia fuego |
| **Sentidos** | Vista ciega 30 ft., visión en la oscuridad 120 ft. |
| **Salvaciones** | Des +4, Con +5, Sab +2, Car +3 |
| **Competencias** | Sigilo +4, Percepción +6 |
| **Aliento (Recarga 5–6):** Cono 30 ft.; DC 15 Des; 12d6 ácido (mitad si acierta). |
| **Mordisco:** +7 al ataque, 2d10+4 perforación + 3d6 veneno. |
| **Garras:** +7 al ataque, 2d6+4 cortante. |

**Comportamiento:** Prioriza aliento si hay varios enemigos; luego mordisco y garras. Si PV < 50% puede intentar huir volando.

---

### **Neronvain**

*(Elfo renegado, guerrero hábil; usa Máscara del Dragón Verde para influencia sobre Chuth. Estadísticas tipo "capitán" élfico con toques de líder cultista.)*

| **Atributo** | **Valor** |
|--------------|-----------|
| **CA** | 16 (armadura de cuero tachonado + agilidad) |
| **PV** | 97 (13d8 + 39) |
| **Velocidad** | 30 ft. |
| **Resistencias** | Ventaja contra encantamiento; inmunidad sueño mágico |
| **Salvaciones** | Des +5, Sab +3 |
| **Competencias** | Atletismo +4, Sigilo +5, Percepción +5, Persuasión +4 |
| **Espada larga:** +6 al ataque, 1d8+4 cortante (versátil 1d10+4). |
| **Arco largo:** +6 al ataque, alcance 150/600 ft., 1d8+4 perforación. |
| **Acción multiataque:** 2 ataques con espada o 2 con arco. |

**Máscara del Dragón Verde (No oficial)** — *Objeto maravilloso, legendario, requiere sintonizarse.*  
Máscara **cornuda de ébano brillante** con aspecto de **cráneo con cuernos**. Cambia de tamaño para adaptarse al usuario que esté en sintonía con ella. Mientras la llevas puesta y en sintonía, puedes acceder a las siguientes propiedades: *(el DM puede completar o usar las que prefiera para la campaña; en este documento no se detallan — narrativamente Neronvain es "amo" de Chuth; opcional: ventaja en Carisma contra Chuth o resistencia a veneno).*

**Captura:** Daño no letal para dejarle a 0 PV e inconsciente; atar y escoltar.

---

### **Neronvain — Versión libro (CR 9)**

*(Para alinear con el original Rise of Tiamat / 5e.tools: Neronvain como antagonista con hechizos y habilidades de wyrmspeaker.)*

| **Atributo** | **Valor** |
|--------------|-----------|
| **CA** | 16 (armadura) + **mod. Carisma** (**Majestad Dracónica**: añade su modificador de Carisma al CA; típicamente CA 18–19) |
| **PV** | 97 (13d8 + 39) |
| **Velocidad** | 30 ft. |
| **Resistencias** | Ventaja contra encantamiento; inmunidad sueño mágico |
| **Salvaciones** | Des +5, Sab +3, Car +4 |
| **Competencias** | Arcanismo +4, Engañar +4, Sigilo +5, Percepción +5 |

**Hechizos (lanzador de conjuros; Carisma):** *eldritch blast* (como flecha eldritch: 3 rayos +5 al ataque, 1d10+4 energía cada uno), *ice storm* (1/día o según slots), *dimension door* (1/día o según slots). El DM puede darle slots de brujo/hechicero nivel 5–6.

**Acciones:**
- **Flecha eldritch (Eldritch Blast):** +5 al ataque, alcance 120 ft., 3 rayos 1d10+4 energía cada uno.
- **Nube venenosa (Acción):** Cono o nube 15 ft.; DC 15 Con; 2d6 veneno (mitad si acierta); Recarga 5–6.
- **Espada larga:** +6 al ataque, 1d8+4 cortante (versátil 1d10+4) si el combate es cuerpo a cuerpo.

**Tácticas (libro):** Ataca desde la distancia con flecha eldritch; usa *nube venenosa* para cubrirse o cortar perseguidores; *dimension door* para replegarse hacia la cámara de Chuth; *ice storm* si hay varios agrupados. Si monta a Chuth, combina ataques a distancia con el aliento del dragón.

**Captura:** Igual que la versión simplificada: daño no letal a 0 PV.

---

### **Otros enemigos (referencia rápida)**

- **Draco guardián:** MM — CA 14, PV 52, mordisco +4, 2d6+2.
- **Cultista del dragón:** MM — CA 13, PV 22, espada corta +3, 1d6+1.
- **Dracónido (dragonclaw / dragonfang):** MM — CA 14, PV 27 (dragonclaw), garras +4, 1d6+2.
- **Ettin:** MM — CA 12, PV 85, dos cabezas, dos ataques por ronda.
- **Elfo cultista:** Usar estadísticas de cultista del dragón con sigilo +2; puede estar en la repisa de la entrada.

Usar los números indicados en Escena 2 y 3; el DM puede subir o bajar la cantidad según tamaño del grupo y nivel.

---

## 📊 **EVENTOS DEL CONSEJO Y MEDIDORES**

Aplicar cuando los PJ **informen en el (próximo) Concilio**. Valores según [01_Tabla_Puntuacion_Consejo.md](../06_Recursos/Tablas/01_Tabla_Puntuacion_Consejo.md).

| **Evento** | **Condición** | **Efecto (resumen)** |
|------------|----------------|----------------------|
| **Capturar a Neronvain** | Neronvain llevado vivo al Consejo / a Melandrach | Arp +1, Ord +1, Laer +1, Dag +1, Conn +1, **Mel +1**, Uld +1, Taer +1, Ist +1; Encl −1. Refuerza juicio élfico (AN10). |
| **Matar a Neronvain** | Neronvain muerto | Arp −1, Ord +1, Encl +1, Laer +1, Dag +1, Conn +1, **Mel −2**, Uld +1, Taer −1, Ist +1. No hay juicio. |
| **Matar a Chuth o expulsarlo de su guarida** | Chuth muerto o huido de la guarida | Arp +1, Ord +1, Encl +1, Laer +1, Dag +1, **Conn +2**, **Mel +2**, Uld +1, Taer +1, Ist +1. |

*(En la tabla completa hay más columnas; aquí solo los que cambian de forma notable. Conn = Connerad, Mel = Rey Melandrach.)*

**Negociar con los elfos de Melandrach sobre Neronvain** se activa en **AN10** si llevan a Neronvain vivo y aceptan el juicio élfico.
...
| **Resultado** | **Efecto** |
|---------------|------------|
| Neronvain capturado, Chuth muerto o expulsado | Máximo beneficio político; AN10 disponible; eventos "Capturar a Neronvain" y "Matar a Chuth o expulsarlo" aplicados en el Concilio. |
| Neronvain muerto, Chuth muerto o expulsado | Amenaza resuelta; Melandrach enfadado (Matar a Neronvain); evento Chuth igualmente aplicable. |
| Chuth huye, Neronvain capturado | Sigue contando como "expulsar a Chuth de su guarida"; Neronvain puede ser juzgado; Chuth puede reaparecer más adelante si el DM lo desea. |
| Neronvain y/o Chuth escapan | Misión incompleta; el DM puede ofrecer un segundo intento (pista de nuevo refugio) o cerrar con consecuencias negativas (Moral del Norte, Melandrach, etc.). |
...
*Este documento contiene toda la información necesaria para dirigir la misión 03 - Neronvain el Verde sin consultar la campaña original ni fuentes externas. Las adaptaciones pactadas (Altand, Everlund, Chuth único) están integradas. La sección "Correspondencia con el original" permite contrastar con el libro o 5e.tools.*
