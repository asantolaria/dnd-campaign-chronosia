# 📊 Medidores del Consejo — Estado Actual
## *Vieja Guardia Rolera - El Alzamiento de Tiamat*

---

> **📖 NAVEGACIÓN:**
> - [Índice Tracking](./00_Indice_Tracking.md) - Volver al tracking
> - [Tabla completa de eventos y modificadores](../06_Recursos/Tablas/01_Tabla_Puntuacion_Consejo.md) - Referencia oficial
> - [Sistema de Tracking](../04_Guia_DM/04_Sistema_Tracking.md) - Guía del DM
...
| Concilio / Momento | Evento | Medidores afectados | Notas |
|--------------------|--------|---------------------|--------|
...
*Este archivo es la copia de trabajo de los medidores para esta campaña. Para la lista completa de eventos y reglas, usar [01_Tabla_Puntuacion_Consejo.md](../06_Recursos/Tablas/01_Tabla_Puntuacion_Consejo.md).*
