...
- ✅ Orden de enfrentar lugartenientes
- ✅ Alianzas y decisiones dentro de las misiones
...
- **`../03_Regiones/`** → Información sobre lugares de Chronosia
...
**Estructura:**
1. **Festival del Reloj Astronómico** (30 min)
   - Ambiente festivo
   - Conocen a Maestro Thaddeus Ironwright
   - Establecen conexión emocional

2. **Asesinato de Thaddeus** (15 min)
   - Kaelthas aparece y mata a Thaddeus
   - Escena dramática y trágica
   - Los PJ ven la amenaza

3. **Investigación** (45 min)
   - Descubren la conexión Thaddeus-Kaelthas
   - Encuentran pistas sobre Cronófagos
   - Rastrean a Kaelthas

4. **Batalla Final** (60 min)
   - Combate contra Kaelthas + secuaces
   - Rescatan a Tiber (opcional)
...
**Objetivo:** Dar libertad total a los PJ mientras la trama paralela avanza.

**Libertad de los PJ:**
- Elegir qué lugartenientes enfrentar
- Orden de las misiones
- Alianzas y decisiones
- Exploración de regiones

**Trama Paralela Automática:**
- **Sesión 4:** Robo del Cronómetro de Realidades
- **Sesión 5:** Robo de la Perla del Vacío Primordial
- **Sesión 5:** Creación del Talismán de Interceptación Divina
...
*Esta estructura está diseñada para que el DM nunca se pierda con la trama paralela mientras los PJ disfrutan del sandbox.*
