# 🌌 Misiones Sandbox de Chronosia
## *Exploración Libre del Reino del Tiempo Fracturado*
...
### **🎯 Información General**
- [Estructura Sandbox](#-estructura-sandbox)
- [El Reloj del Ritual](#️-el-reloj-del-ritual-presión-del-sandbox)
- [La Guerra entre Lugartenientes](#️-la-guerra-entre-lugartenientes)

### **⏰ Regiones Temporales (3 Principales + 2 Menores + 1 Caída)**
- [⚰️ Valle de la Aguja Suspendida (Thyra - CAÍDA)](#-valle-de-la-aguja-suspendida-thyra---caída)
- [La Espiral Inversa (Serapis - Principal)](#-la-espiral-inversa-serapis---principal)
- [El Abismo de los Posibles (Varrak - Principal/Neutral)](#-el-abismo-de-los-posibles-varrak---principalneutral)
- [La Mansión de la Sed Eterna (Vorthak - Principal/Líder)](#-la-mansión-de-la-sed-eterna-vorthak---principallíder)
- [El Jardín de los Tiempos Gemelos (Medusa - Menor)](#-el-jardín-de-los-tiempos-gemelos-medusa---menor)
- [Las Ruinas del Tiempo Perdido (Tempus - Menor)](#-las-ruinas-del-tiempo-perdido-tempus---menor)

### **🌌 Regiones Dimensionales (5 Principales + 1 Menor)**
- [Archipiélago de Barbanegra (Edward Teach - Principal/Independiente)](#-archipiélago-de-barbanegra-edward-teach---principalindependiente)
- [Las Llanuras de la Compresión (Dimensionalis - Principal/Independiente)](#-las-llanuras-de-la-compresión-dimensionalis---principalindependiente)
...
### **Libertad Total**
A partir de la llegada a Chronosia, los PJ pueden:
- **Explorar cualquier región** desbloqueada en cualquier orden
- **Enfrentar lugartenientes** como deseen (respetando los bloqueos)
- **Establecer alianzas** con facciones locales
- **Descubrir secretos** a su propio ritmo
- **Influenciar la competencia** entre lugartenientes
...
- **Traiciones**: Pueden atacarse entre sí
- **Varrak como Indeciso**: El Oráculo puede aliarse con los PJ o con Aethernus (elige en Fase 3)
- **Edward Teach como Amenaza**: Es un punto ciego para Varrak, impredecible, y crece con cada lugarteniente desatendido

### **⏳ El Reloj del Ritual (presión del sandbox)**

**📖 Fuente única:** [10_Motor_de_Campana_Reloj_y_Puertas.md](../../02_Guia_DM/10_Motor_de_Campana_Reloj_y_Puertas.md)

La presión la marca un **único motor**: el **Reloj del Ritual** (8 segmentos, empieza en 2/8), que mide la ascensión de Aethernus. No hay sistema de balance temporal/dimensional (retirado). El coste de explorar es el **tiempo**: no da para todo, hay que **elegir** (realistamente 4-6 regiones).

**📊 Qué mueve el Reloj:**

| Avanza (+1) | Frena / retrocede |
|---|---|
| Explorar una región a fondo | Derrotar a un lugarteniente **crítico** (Vorthak, Ignis, Teach) |
| Hitos de Barbanegra (Thyra = SALTO) | Sabotaje de los Anacronistas (congela) |
| Desatender a Teach (caza a otro → +1, crece) | Sacrificio de Varrak (**−1**) |

A **8/8** → Llamada de los Dioses → se abre la Torre (clímax).

**👥 Voces que lo explican:**
- **Galen (Anacronistas)**: lee el Contador del Ritual de Cronópolis
- **Varrak del Horizonte**: visiones de la ascensión inminente
- **Capitán Marcus (La Resistencia)**: datos del Contador y urgencia

**Estrategia Recomendada:** Frenar a los críticos (sobre todo Teach) para contener el Reloj y llegar a tiempo a la Torre.

---

## ⚰️ **VALLE DE LA AGUJA SUSPENDIDA (THYRA - CAÍDA)**
...
- **Estado**: La región queda devastada pero accesible tras la muerte de Thyra; **el camino a la Torre solo se franquea con el Reloj a 8**
...
- **Reloj**: Explorar esta región a fondo avanza el Reloj del Ritual (+1)
...
- **Pistas**: Historia de Chronosia, poder de Serapis, secretos del pasado, conexión con la guerra entre lugartenientes
...
## 🌊 **EL ABISMO DE LOS POSIBLES (VARRAK - PRINCIPAL/NEUTRAL)**
...
- **Tres Caminos**:
  ...
  - **Siervo**: Se convierte en leal servidor de Aethernus
...
## 🏰 **LA MANSIÓN DE LA SED ETERNA (VORTHAK - PRINCIPAL/LÍDER)**
...
- **Secundarios**: Liberar a los esclavos de sangre, obtener artefactos vampíricos, descubrir secretos de la sed eterna
- **Reloj**: Vorthak es un lugarteniente **CRÍTICO** (líder temporal); derrotarlo **frena el Reloj del Ritual**
...
- **⚠️ CUIDADO**: Puede transferir todo el daño recibido a sus secuaces

#### **🎭 Elementos Narrativos**
- **Dilema Moral**: Liberar esclavos puede debilitar a Vorthak pero pone en riesgo sus vidas
...
**🎭 LUGARTENIENTE TEMPORAL** - Implicado en la guerra entre lugartenientes
...
- **Secundarios**: Descubrir secretos de la ciudad perdida, obtener tecnología temporal, liberar habitantes
- **Reloj**: Región menor; explorarla a fondo aun así avanza el Reloj del Ritual
...
## 🏴‍☠️ **ARCHIPIÉLAGO DE BARBANEGRA (EDWARD TEACH - PRINCIPAL/INDEPENDIENTE)**
...
#### **🎯 Objetivos**
- **Principal**: Derrotar a **Edward Teach** y recuperar el poder robado de Thyra
- **Secundarios**: Liberar islas piratas, obtener tesoros dimensionales, vengar a Thyra
- **Reloj**: Teach es el lugarteniente **CRÍTICO** central; derrotarlo **frena el Reloj** y le impide seguir absorbiendo lugartenientes
...
- **Estrategias**: Prepararse para combinaciones devastadoras de portales y estasis
- **⚠️ PELIGRO**: Combina poderes dimensionales + temporales robados de Thyra; crece con cada lugarteniente que los PJ desatienden
- **Recompensas**: Elección entre **Brújula de los Mares** O **Cofre del Tesoro Pirata**
- **Estado de Acceso:** 🔒 **CERRADO** (mar en calma muerta) → 🔓 al construir el **Motor de Viento Perpetuo** (Serapis + Ymir). No depende del asesinato de Thyra

**Ver más detalles en:** [11_Regiones_Dimensionales.md](../../03_Regiones/11_Regiones_Dimensionales.md)

---

## 🏔️ **LAS LLANURAS DE LA COMPRESIÓN (DIMENSIONALIS - PRINCIPAL/INDEPENDIENTE)**
...
- **Secundarios**: Explorar espacios comprimidos, obtener artefactos dimensionales, descubrir secretos espaciales
- **Reloj**: Explorar esta región a fondo avanza el Reloj del Ritual (+1)
...
- **⚠️ MECÁNICA ESPECIAL**: Puede separar a los PJ en habitaciones dimensionales con criaturas
...
## 🔥 **LAS CALDERAS DIMENSIONALES (IGNIS - PRINCIPAL/LÍDER)**
...
- **Reloj**: Ignis es un lugarteniente **CRÍTICO** (líder dimensional); derrotarlo **frena el Reloj** y **abre el ala dimensional profunda** (Dimensionalis, Veldrisza)
...
- **⚠️ PELIGRO**: Puede invocar oleadas constantes de crías de dragón y elementales
- **Recompensas**: Tesoros de dragón rojo ancestral
- **Estado de Acceso:** 🔒 **Bloqueada** - Acceso por el Motor de Viento / red de portales; derrotarlo abre el ala dimensional profunda

**Ver más detalles en:** [11_Regiones_Dimensionales.md](../../03_Regiones/11_Regiones_Dimensionales.md)

---

## 🕷️ **LA CIUDAD SUBTERRÁNEA DE VELDRISZA (MATRONA VELDRISZA - PRINCIPAL)**
...
- **Secundarios**: Liberar la ciudad drow, obtener artefactos drow, descubrir secretos subterráneos
- **Reloj**: Explorar esta región a fondo avanza el Reloj del Ritual (+1)
...
- **⚠️ MECÁNICA ESPECIAL**: Puede invocar ejércitos completos desde Menzoberranzan
...
## 🪞 **EL JARDÍN DE LOS TIEMPOS GEMELOS (LAS GEMELAS - PRINCIPALES/NEUTRALES)**
...
#### **🎯 Objetivos**
- **Principal**: Derrotar a **Las Gemelas del Espejo** y cerrar la dimensión espejo
- **Secundarios**: Resolver puzzles de espejos, descubrir el origen de las gemelas, obtener artefactos de reflejos
- **Reloj**: Explorar esta región a fondo avanza el Reloj del Ritual (+1)
...
- **⚠️ MECÁNICA ESPECIAL**: El daño a los clones se comparte con el original (50%)
...
**🎭 LUGARTENIENTE DIMENSIONAL** - Implicado en la guerra entre lugartenientes
...
- **Reloj**: Región de entrada; junto con Serapis da las dos partes del **Rotor Infinito** → Motor de Viento → abre el mar (Teach)
...
- **Ventajas**: Conocimiento del tiempo verdadero, guía a través de distorsiones, información sobre el pasado
...
- **Objetivo**: Revelar que Aethernus es en realidad un clone de Manshoon
...
- **Mecánica**: Frenar el Reloj derrotando a los críticos (Vorthak, Ignis, Teach), sabotaje de los Anacronistas o sacrificio de Varrak
- **Consecuencias**: Si el Reloj llega a 8 con Teach crecido, se desencadena el peor final

### **La Caza de Teach**
- **Objetivo**: Descubrir que Teach absorbe a los lugartenientes que los PJ no alcanzan y crece
- **Mecánica**: "Hipos" del Contador que los PJ no provocaron + regiones que siguen rotas → pruebas de que fue Teach
- **Oportunidades**: Aprovechar conflictos entre lugartenientes para debilitarlos antes de que Teach llegue a ellos

---

## 🎮 **TRANSICIÓN AL CLÍMAX**

### **Acceso a la Torre de la Eternidad**
- **Requisito**: El **Reloj del Ritual llega a 8** → Llamada de los Dioses → se abre la Torre
...
### **Mecánicas de Presión Final (el Reloj)**
- **Sistema de Avisos**: Las voces (Galen, Varrak, Marcus) intensifican según avanza el Reloj
- **Revelaciones Garantizadas**: Los PJ descubren el impacto de sus acciones (y de lo que dejaron crecer a Teach)
- **Consecuencias Naturales**: El mundo responde visiblemente a la ascensión inminente
- **Agencia Significativa**: Las decisiones finales tienen peso máximo

---

*Esta estructura sandbox permite a los jugadores explorar Chronosia a su propio ritmo mientras mantiene la tensión narrativa, la rivalidad entre lugartenientes y las consecuencias de sus acciones. El Reloj del Ritual añade profundidad estratégica (coste de oportunidad) sin limitar la libertad de los jugadores.*
