...
SESIONES 1-3: Railroad (Establecer mundo y personajes)
    ↓
SESIÓN 4: ROBO DEL CRONÓMETRO (Evento catalizador #1)
    ↓
SESIÓN 4-5: ROBO DE LA PERLA + CREACIÓN DEL TALISMÁN
    ↓
SESIÓN 5-6: ASESINATO DE THYRA (Evento catalizador #2)
    ↓
...
### **Objetivo de esta Fase:**
Edward Teach ejecuta su plan maestro: roba los artefactos, crea el Talismán, asesina a Thyra, y desencadena La Ascensión del Cónclave.
...
| **12** | ⚠️ Ritual al 92%, urgencia máxima | 12-13 | Variable |
...
| **Sesión** | **Evento Principal** | **Nivel** | **Ubicación** |
|------------|----------------------|-----------|---------------|
| **13** | ⚠️⚠️⚠️ Llamada de los dioses, ritual al 98% | 13 | Torre (exterior) |
...
- **Lugartenientes Totales: 12**
  - **8 Principales:** Vorthak, Serapis, Edward Teach, Ignis, Veldrisza, Dimensionalis, Las Gemelas, Varrak
  - **4 Menores:** Medusa, Tempus, Ymir, Kaelthas (muerto en Sesión 1)
  - **1 Caído:** Thyra (muere en Sesión 5-6)
...
- **Total de Lugartenientes a Derrotar:** 
  - **Sesión 1:** Kaelthas (Menor)
  - **Sesiones 3-12:** 8 principales + 2-3 menores adicionales (10-11 total)
...
- Usa el sistema de puntos (`06_Eventos_Ascension_Conclave.md`) para simular el mundo vivo
...
- Pero el ritual DEBE estar al 98% cuando se llame a los PJ
- Ajusta el progreso del ritual según el ritmo de la mesa
