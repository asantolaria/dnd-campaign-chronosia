...
## 🏗️ **ESTRUCTURA Y NIVELES POR FASE**

> **Fuente de verdad de la estructura:** [00_Estructura_Campana.md](../04_Aventuras/00_Estructura_Campana.md). Timeline detallado: [07_Cronologia_Maestra_Campana.md](./07_Cronologia_Maestra_Campana.md). Aquí solo el resumen de mesa.

| Fase | Sesiones | Niveles | Estilo | Hitos clave |
|------|----------|---------|--------|-------------|
| **0 · Railroad inicial** | 1-3 | 3 → 4 | Lineal | Festival → asesinato → llegada a Cronópolis. [Guía](../04_Aventuras/Fase_0_Railroad_Inicial/00_Guia_General_Fase_0.md) |
...
*Dirigir Chronosia es un desafío único que combina sandbox y railroad para crear una experiencia épica e inolvidable.*
