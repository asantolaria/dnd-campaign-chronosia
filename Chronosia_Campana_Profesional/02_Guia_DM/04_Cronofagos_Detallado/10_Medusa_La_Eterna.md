...
![Medusa la Eterna](../../assets/bestiario/lugartenientes/10_medusa.jpg)
...
### **MEDUSA LA ETERNA**
*Monstruo Mediano (Medusa Ancestral), Neutral Malvado*
...
**Mirada Temporal.**  
Medusa puede congelar el tiempo con su mirada, no solo petrificando cuerpos sino también el flujo temporal. Sus víctimas quedan atrapadas en un momento eterno.
...
1. Usa *Mirada Temporal* para paralizar amenazas mayores
2. Activa *Campo de Estasis* para paralizar múltiples enemigos
3. Se posiciona estratégicamente

### **Fase 2: Ofensiva (Rounds 3-5)**
- Usa *Petrificación Temporal* para eliminar amenazas
- Mantiene distancia mientras paraliza enemigos
- Usa *Serpientes de Tiempo* para daño constante

### **Fase 3: Defensiva (HP < 50)**
- Activa *Estasis Definitiva* para regenerar
- Usa *Congelación Masiva* para paralizar a todos
- Prioriza supervivencia sobre ofensiva

### **Estrategias Especiales:**
- **Contra Múltiples Enemigos:** Usa *Campo de Estasis* + *Congelación Masiva*
- **Contra Tanques:** Usa *Petrificación Temporal* para paralizarlos
- **Contra Hechiceros:** Usa *Mirada Temporal* para interrumpir concentración
