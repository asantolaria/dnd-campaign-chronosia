...
**⚠️ DESPUÉS DEL ASESINATO:** El valle quedó permanentemente congelado en estasis temporal. Todo en la región está suspendido en un momento eterno. La región es ahora **inaccesible** para los PJ, convertida en un monumento a la traición de Edward Teach.

### **Condiciones Especiales**
- ⚰️ Toda la región está congelada en estasis permanente
- Las criaturas atrapadas ya no pueden ser liberadas
- Los sonidos se han detenido completamente
- El aire es cristal sólido, imposible de respirar
- **La región NO puede ser explorada en la campaña actual**

### **Habitantes (Todos Congelados)**
- **Ecos Petrificados**: Sombras de personas atrapadas eternamente
- **Constructos Guardianes**: Congelados en medio de sus patrullas
- **Comunidad de Cronistas**: Atrapados con consciencia eterna pero sin movimiento

### **Puntos de Interés (Inaccesibles)**
- **La Aguja Central**: Ahora emite pulsos de estasis permanente
- **El Mercado Congelado**: Comerciantes convertidos en estatuas de cristal
- **El Bosque de Cristal**: Árboles eternamente petrificados
- **La Torre del Relojero**: Donde el maestro murió intentando detener la estasis

### **Mecánicas de Juego**
- **⚰️ Región Bloqueada:** No accesible para los PJ
- **Narrativa:** Puede ser vista desde lejos como advertencia del poder de Edward Teach
- **Tesoro Perdido:** Los tesoros de Thyra están permanentemente inaccesibles
...
**Contador Inicial:** 20 Puntos de Arena al amanecer

La región funciona con un sistema de **Puntos de Arena** que representan cuánto tiempo queda antes del reinicio:

- **20 puntos**: Arena en la parte superior, tiempo estable
- **10-15 puntos**: Arena a la mitad, tensión creciente
- **5-9 puntos**: Arena bajando rápido, urgencia crítica
- **0 puntos**: ⚠️ **REINICIO TOTAL** → Todo vuelve al amanecer del día anterior

#### **📉 Acciones que BAJAN la Arena (Pierden Tiempo):**

- **Cada turno de combate**: -1 punto
- **Usar hechizos de nivel 3+**: -2 puntos
- **Hacer daño significativo a Serapis (25+ HP)**: -1 punto
- **Descanso corto**: -3 puntos
- **Descanso largo**: -5 puntos (NO recomendado)
- **Muerte de un PJ**: -2 puntos
- **Hora de oscuridad (cada hora de noche)**: -1 punto automático

#### **📈 Acciones que SUBEN la Arena (Ganan Tiempo):**

- **Destruir Cristales de Arena** (dispersos por la región): +2 puntos
- **Resolver puzzles temporales**: +3 puntos
- **Ayudar a los aldeanos con su trabajo**: +1 punto por hora de trabajo físico
- **Sacrificar un objeto mágico al Reloj**: +5 puntos (el objeto se destruye)
- **Derrotar enemigos menores sin combate prolongado**: +1 punto
...
5. El Contador **vuelve a 20 puntos**
...
### **Habitantes**
- **Portadores de Arena**: 200 aldeanos que trabajan turnos de 12 horas
- **El Maestro Relojero**: Anciano que conoce todos los secretos del Reloj
- **Niños Temporales**: Niños que han vivido el mismo día cientos de veces
- **Guardianes del Cristal**: Protegen los Cristales de Arena dispersos
- **Conscientes del Bucle**: Aldeanos que recuerdan cada reinicio (enloquecidos)
...
#### **💎 Cristales de Arena (12 dispersos por la región)**
- Cristales brillantes del tamaño de una persona
- Al destruirlos, liberan +2 puntos de arena
- Están protegidos por Guardianes del Cristal (CR 4-6)
...
- Exploran sin prisa, descubren Cristales de Arena
- Hablan con aldeanos, aprenden sobre el trabajo del tiempo
- Localizan la Torre de Serapis
- Planifican ruta óptima para el siguiente intento

**Reinicio 2 (Optimización):**
- Destruyen Cristales de Arena rápidamente (+24 puntos total si destruyen todos)
- Ayudan a aldeanos con trabajo físico (+3-4 puntos)
- Evitan combates innecesarios
- Llegan a la Torre de Serapis con Contador en 15+ puntos

**Reinicio 3 (Ejecución Final):**
- Ruta perfectamente optimizada
- Enfrentamiento con Serapis con tiempo suficiente
- Victoria o derrota definitiva
